...
new Vue({
    ...
    methods: {
        async init() {
            ...
            const url = `http://10.11.192.98:8080/StuForum_war/api/forum/Son?uname=${encodeURIComponent(uname)}`; // 本地IP
        ...
        //获取关注者数量
        async getGzNum() {
            const url = `http://10.11.192.98:8080/StuForum_war/api/concernedGzNum?fedId=${this.fedId}`; // 学校IP
